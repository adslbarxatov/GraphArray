# GraphArray: полное руководство пользователя
> **ƒ** &nbsp;Nicolay B. aka RD_AAOW, Соля́ников Я.; 29.04.2025; 3:06
...
- [Ссылки для загрузки](https://adslbarxatov.github.io/DPArray/ru#grapharray)
- [English version](https://adslbarxatov.github.io/GraphArray)

---

# 1. Общие сведения о программе

***GraphArray*** (ранее известный как Geomag data drawer) – программное средство, предназначенное для построения диаграмм на основе табличных данных.
...
GraphArray поддерживает следующие форматы представления данных:
...
так и её стиль и настройки отображения (файлы данных GraphArray, `.gdd`).
...
В части визуализации и обработки данных GraphArray обеспечивает следующие основные возможности:
...
дополнительных программных комплексов. Поэтому ***GraphArray*** можно считать весьма полезным инструментом обработки и визуализации табличных данных.
...
<img src="/GraphArray/img/2_01_ru.png" />
...
&#x25B6; Кнопки добавления (<img src="/GraphArray/img/2_70.png" />) и удаления (<img src="/GraphArray/img/2_73.png" />) кривых и дополнительных объектов.

&#x25B6; Кнопка скрытия / отображения (<img src="/GraphArray/img/2_60.png" />) кривых и объектов.
...
&#x3000;&#x25B7; в каком диапазоне абсцисс и ординат следует построить кривую, а также требуется ли транспонирование (вкладка <img src="/GraphArray/img/2_33.png" />);

&#x3000;&#x25B7; как следует расположить изображение кривой и/или объекта на листе, а также какого оно должно быть размера (вкладка <img src="/GraphArray/img/2_34.png" />);

&#x3000;&#x25B7; требуется ли вручную установить расположение подписей диаграммы и название рисунка, или программа должна установить их автоматически (вкладка <img src="/GraphArray/img/2_36.png" />);

&#x3000;&#x25B7; как следует отображать координатные оси диаграммы (вкладка <img src="/GraphArray/img/2_46.png" />);

&#x3000;&#x25B7; как следует отображать координатную сетку диаграммы (вкладка <img src="/GraphArray/img/2_47.png" />);

&#x3000;&#x25B7; как следует отображать подписи диаграммы (вкладка <img src="/GraphArray/img/2_48.png" />);

&#x3000;&#x25B7; как следует отображать линии кривых диаграммы (вкладка <img src="/GraphArray/img/2_49.png" />).
...
Для этого программа создаёт файл стандартного шаблона `GraphArray.txt` (если его ещё нет), аналогичный тому, который используется в функции
...
<img src="/GraphArray/img/2_70.png" /> рядом со списком кривых
...
<img src="/GraphArray/img/2_03_ru.png" />
...
С помощью кнопки <img src="/GraphArray/img/2_73.png" /> можно
...
С помощью кнопки <img src="/GraphArray/img/2_60.png" /> пользователь
...
<img src="/GraphArray/img/2_50_ru.png" />
...
<img src="/GraphArray/img/2_37.png" /> и <img src="/GraphArray/img/2_38.png" />, что будет соответствовать
...
Диапазона построения также можно управлять с помощью колёсика мыши:
- Без клавиш колёсико позволяет смещать диапазоны построения по оси `Oy` (вертикально);
- С зажатой клавишей `[Shift]` колёсико позволяет смещать диапазоны построения по оси `Ox` (горизонтально);
- С зажатой клавишей `[Ctrl]` колёсико выполняет «приближение / удаление» – одновременное сближение / удаление границ диапазонов по всем осям.
...
<img src="/GraphArray/img/2_51_ru.png" />
...
<img src="/GraphArray/img/2_53_ru.png" />
...
<img src="/GraphArray/img/2_54_ru.png" />
...
<img src="/GraphArray/img/2_55_ru.png" />
...
<img src="/GraphArray/img/2_56_ru.png" />
...
<img src="/GraphArray/img/2_57_ru.png" />
...
Если пользователь выбрал файл данных GraphArray (`.gdd`), в котором уже содержались настройки отображения кривых и графических
...
<img src="/GraphArray/img/3_22_ru.png" />
...
<img src="/GraphArray/img/3_81_ru.png" />
...
<img src="/GraphArray/img/3_82_ru.png" />
...
<img src="/GraphArray/img/3_17_ru.png" />
...
<img src="/GraphArray/img/3_21_ru.png" />
...
<img src="/GraphArray/img/3_63_ru.png" />
...
<img src="/GraphArray/img/3_40_ru.png" />
...
- Перемещение текущей выбранной строки на одну позицию вверх (кнопка <img src="/GraphArray/img/3_41.png" />).
В качестве текущей здесь и далее выступает последняя выделенная строка.
- Перемещение текущей выбранной строки на одну позицию вниз (кнопка <img src="/GraphArray/img/3_42.png" />).
- Добавление строки перед текущей выбранной (кнопка <img src="/GraphArray/img/3_43.png" />).
- Добавление строки после текущей выбранной (кнопка <img src="/GraphArray/img/3_44.png" />).
- Удаление выбранных строк (кнопка <img src="/GraphArray/img/3_45.png" />).
...
[здесь](https://github.com/adslbarxatov/GraphArray/tree/master/VIGScripts) или путём сохранения
...
- `GraphArray.exe` – исполняемый модуль программы;
...
- `GraphArray.txt` – файл шаблона отображения открываемых файлов данных, содержащий описание автоматически добавляемых кривых;
...
- `GraphArray.exe` – запуск программы;
- `GraphArray.exe /?` – отображение сообщения с вариантами использования программы из командной строки;
- `GraphArray.exe <имя_файла>` – загрузка файла «имя_файла»;
- `GraphArray.exe <имя_файла> <имя_файла_2> [SLC] [ECC]` – преобразование файлов из первого формата во второй. В качестве конечных файлов
...
данных GraphArray во избежание потерь данных.
